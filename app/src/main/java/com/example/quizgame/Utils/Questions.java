...
public class Questions {
    ...
    public void addScienceQuestion() {
        ...
        geographyLevel1.add(new QuizModel("В какой стране находится одно из оставшихся семи чудес света??", "Египет", "Италия", "Египет", "Англия", "Македония"));
        geographyLevel1.add(new QuizModel("Этот океан самый маленький и холодный", "Северный Ледовитый", "Атлантический", "Тихий океан", "Северный Ледовитый", "Индийский океан"));
        geographyLevel1.add(new QuizModel("Какой остров можно надеть на голову?", "Сомбреро", "Новая Зеландия", "Карибский остров", "Фиджи", "Сомбреро"));
        geographyLevel1.add(new QuizModel("Назовите самую длинную реку?", "Нил", "Нил", "Рейн", "Янцзы", "Амазонка"));
        geographyLevel1.add(new QuizModel("Он сам вода и плавает по воде?", "Лёд", "Вода", "Лёд", "Соль", "Н2О"));
        geographyLevel1.add(new QuizModel("Как называется австралийская дикая собака?", "Динго", "Доберман", "Алабай", "Динго", "Руперт"));
        geographyLevel1.add(new QuizModel("Черным золотом называют…", "Нефт", "Нефт", "Хлопок", "Золота", "Алмаз"));
        geographyLevel1.add(new QuizModel("Назовите скопление мелких пригородов вокруг центрального города?", "Агломерация", "Централизация", "Агломерация", "Урбанизация", "Нет правилного ответа"));
        geographyLevel1.add(new QuizModel("Столица Ливии", "Триполи", "Крит'", "Варшава", "Триполи", "Люблана"));
    ...
    public void levels() {
        levelsGeography = new ArrayList<Levels>();

        levelsGeography.add(new Levels("Угадай флаг", "Найдите флаг страны из рисунка", R.drawable.img_flag, R.drawable.star1));
        levelsGeography.add(new Levels("Вопросы 5-7 класса", "Вопросы из школы 5-7 класса", R.drawable.ic_5_7, R.drawable.star1));
        levelsGeography.add(new Levels("Вопросы 8-9 класса", "Вопросы из школы 8-9 класса", R.drawable.ic_8_9, R.drawable.star1));
        levelsGeography.add(new Levels("Вопросы 10-11 класса", "Вопросы из школы 10-11 класса", R.drawable.ic_10_11, R.drawable.star1));
        levelsGeography.add(new Levels("Увлекательные вопросы", "Увлекательные вопросы по географию", R.drawable.safari, R.drawable.star1));
    }

    public ArrayList<QuizModel> getGeographyLevel1() {
        return geographyLevel1;
    }
    ...
    public ArrayList<QuizModel> getMath() {
        return math;
    }

    public ArrayList<QuizModel> getBiology() {
        return biology;
    }

    public ArrayList<QuizModel> getEnglish() {
        return english;
    }

    public ArrayList<QuizModel> getGeometry() {
        return geometry;
    }

    public ArrayList<Levels> getLevelsGeography() {
        return levelsGeography;
    }
}
